/* ============================================================
   VET PATAS — Citas en línea (calendario demo)
   ============================================================ */

(function () {
  "use strict";

  var WHATSAPP_NUMBER = "529601427950"; // NÚMERO A REEMPLAZAR por el de la veterinaria
  ...
  function fmtPrice(p) {
    if (typeof p === "string" && p.indexOf("Desde ") === 0) return p;
  ...
  confirmBtn.addEventListener("click", function () {
    ...
    var texto =
      "Hola, quiero agendar una cita en Vet Patas." +
      "\n\n• Servicio: " + selection.service + " (" + fmtPrice(selection.price) + ")" +
      "\n• Fecha: " + fmtDate(selection.date) +
      "\n• Hora: " + selection.slot +
      "\n\nNombre de mi mascota: ___" +
      "\nMi nombre es: ___" +
